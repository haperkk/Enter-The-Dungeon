...
public class RoomTemplateSO : ScriptableObject
{
    ...
    private void OnValidate()
    {
        ...
        if (enemiesByLevelList.Count > 0 || roomLevelEnemySpawnParametersList.Count > 0)
        {
            HelperUtilities.ValidateCheckEnumerableValues(this, nameof(enemiesByLevelList), enemiesByLevelList);
            HelperUtilities.ValidateCheckEnumerableValues(this, nameof(roomLevelEnemySpawnParametersList), roomLevelEnemySpawnParametersList);
