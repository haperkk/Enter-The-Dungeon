...
public class DungeonBuilder : SingletonMonobehaviour<DungeonBuilder>
{
    ...
    private bool AttempToBuildRandomDungeon(RoomNodeGraphSO roomNodeGraph)
    {
        ...
        {
            Debug.Log("No Entrance Room Node In Room Node Graph");
            return false;
        }
    ...
    private bool PlaceTheRoom(Room parentRoom, Doorway doorwayParent, Room room)
    {
        ...
        {
            //todo: why we mark doorwayparent as unavailable here?
            // Just mark the parent doorway as unavailable so we don't try and connect it again
            doorwayParent.isUnavailable = true;
    ...
    private Room CreateRoomFromRoomTemplate(RoomTemplateSO roomTemplate, RoomNodeSO roomNode)
    {
        ...
        room.roomLevelEnemySpawnParametersList = roomTemplate.roomLevelEnemySpawnParametersList;
    ...
    private void ClearDungeon()
    {
        ...
        {
            foreach (var room in dungeonBuilderRoomDictionary.Values)
            {
